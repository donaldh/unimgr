...
public class CiscoRestRunner implements CiscoExecutor{
	...
	/*public static void main(String[] args) {
		try {
			CiscoExecutor restRunner = new CiscoRestRunner(InetAddress.getByName("192.168.10.204"), "POC", "POC");
//			restRunner.setRunningConfig(new String ("interface GigabitEthernet4\nservice instance 201 ethernet\ndescription Mirek tests"));
			String runningConfig = restRunner.getRunningConfig();
